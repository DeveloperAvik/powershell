############################################################################################################################################################                      
#                                  |  ___                                            _       _               #              ,d88b.d88b                     #                                 
# Title        : Shortcut-Avik     | |_ _|   __ _   _ __ ___       ^             _  | | __  | |__    _   _   #              88888888888                    #           
# Author       : Developer Avik    |  | |   / _` | | '_ ` _ \     / \   \    /  | | | |/ /  | | '_ \| | | |  #              `Y8888888Y'                    #           
# Version      : 1.0               |  | |  | (_| | | | | | | |   / _ \   \  /   | | |   <   | |_) | |_|_| |  #               `Y888Y'                       #
# Category     : Execution         | |___|  \__,_| |_| |_| |_|  /     \   \/    |_| |_ |\_\ |_|_.__/     \|  #                 `Y'                         #
...
#                                                                                                            #         /       \   /     ~ \               #
#  github.com/DeveloperAvik                                                                                  #         \       /   \~     ~/               #         
#  facebook.com/avik0001                                                                                     #   /\_/\_/\__  _/_/\_/\__~__/_/\_/\_/\_/\_/\_#                     
#  instagram.com/avik0001                                                                                    #  |  |  |  | ) ) |  |  | ((  |  |  |  |  |  |#              
#  youtube.com/c/DeveloperJi                                                                                 #  |  |  |  |( (  |  |  |  \\ |  |  |  |  |  |#
############################################################################################################################################################
...
$code = "Add-Type -AssemblyName PresentationCore,PresentationFramework; [System.Windows.MessageBox]::Show('You are Hacked')"
